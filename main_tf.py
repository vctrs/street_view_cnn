...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        for input in os.listdir("C:\\Users\\victo\\Desktop\\data elective\\images_weimar"):

            output_image_path ="C:\\Users\\victo\\Desktop\\data elective\\images_weimar\\" + input.rstrip('.jpg')+r'_out.png'
            
        # Read and predict on a test image
            input_image = cv2.imread("C:\\Users\\victo\\Desktop\\data elective\\images_weimar\\"+input)
